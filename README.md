...
- ✅ Web frontend built — drawing canvas, predict/clear controls, confidence score, and per-class probability bars, responsive across mobile and desktop
...
- Automatic digit centering before inference
- Improved preprocessing pipeline
- Real-time prediction while drawing (currently button-triggered)
